    ...
    <>
      <S.Container>
          <S.Form onSubmit={handleSubmit(onSubmit, onError)}>
            ...
            <input type="text" className="join_input" id="email" name="email" {...register("email", {
              required: {
                message: "이메일을 입력해주세요.",
                value: true
              },
            ...
            <input type="password" className="join_input" id="password" name="password" {...register("password", {
              required: {
            ...
            <input type="password" className="join_input" id="password_check" name="passwordCheck" {...register("passwordCheck", {
              required: {
                message: "비밀번호를 입력해주세요.",
                value: true
              },
            ...
            <input type="text" className="join_input" id="name" name="username" {...register("username", {
              required: {
                message: "이름을 입력해주세요.",
                value: true
              }
